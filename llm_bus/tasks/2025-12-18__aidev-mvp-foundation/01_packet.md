...
```
 ✓ tests/redactor.test.ts (8 tests)
 ✓ tests/impact-analyzer.test.ts (5 tests)
 ✓ tests/schemas.test.ts (4 tests)
 ✓ tests/model-loader.test.ts (3 tests)
 ✓ tests/token-estimator.test.ts (8 tests)
 ✓ tests/errors.test.ts (6 tests)
 ✓ tests/git-diff.test.ts (6 tests)
 ✓ tests/allocator.test.ts (6 tests)
 ✓ tests/determinism.test.ts (5 tests)
 ✓ tests/cli.test.ts (1 test)
 ✓ tests/git-service.test.ts (4 tests)
